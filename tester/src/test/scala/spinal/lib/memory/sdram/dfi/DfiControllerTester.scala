...
/**
 * DfiController的完整测试套件
 */
class DfiControllerTester extends SpinalAnyFunSuite {

  test("DfiController should instantiate correctly with DDR3") {
    println("=== Testing DfiController DDR3 instantiation ===")
    ...
    // 验证DFI控制器配置可以创建
    println("✓ DfiController DDR3 instantiation test passed")
  }

  test("DfiController should instantiate correctly with DDR4") {
    println("=== Testing DfiController DDR4 instantiation ===")
    ...
    // 验证DFI控制器配置可以创建
    println("✓ DfiController DDR4 instantiation test passed")
  }
}